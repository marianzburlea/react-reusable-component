...
export const topLinkList: TLink[] = [
  {
    label: 'Owner',
    href: '#owner',
    color: 'primary',
...
export const footerLinkList: TLink[] = [
  {
    label: 'Why TrustUs',
    href: '#why-trust-us',
    color: 'primary',
...
export const popularCategorySkillList: TSkill[] = [
...
export const footerIconList: TIconButton[] = [
  { href: '#', title: 'Pilot', icon: 'airplane' },
  { href: '#', title: 'Writer', icon: 'pencil7' },
  { href: '#', title: 'Photographer', icon: 'image' },
  { href: '#', title: 'Actor', icon: 'clapboard-play' },
  { href: '#', title: 'Explorer', icon: 'location3' },
  { href: '#', title: 'Firefighter', icon: 'fire' },
]

export const bannerInfo: TBanner = {
...
export const homepageCardList: TBanner[] = [
  {
